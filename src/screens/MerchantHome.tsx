...
const RECENT_TXS = [
  { id: '1', customer: 'Sunrise Café', type: 'Payment received', amount: '+$148.50', time: '2 min ago', initials: 'SC', color: '#F5B700' },
  { id: '2', customer: 'Office Supplies Co', type: 'Invoice paid', amount: '+$320.00', time: '1h ago', initials: 'OS', color: '#0066FF' },
  { id: '3', customer: 'Freelance — J. Kim', type: 'QR payment', amount: '+$75.00', time: '3h ago', initials: 'JK', color: '#9945FF' },
  { id: '4', customer: 'Payout to Chase', type: 'Bank transfer', amount: '-$1,200.00', time: 'Yesterday', initials: '↑', color: '#AFC5FF' },
]
        ...
        >
          <div className="flex items-start justify-between mb-4">
            <div>
              ...
              <p className="font-display text-3xl font-extrabold text-white leading-none">$543.50</p>
          ...
          <div className="flex gap-3 mt-4 pt-4" style={{ borderTop: '1px solid rgba(175,197,255,0.1)' }}>
            {[
              { label: 'This Week', value: '$2,410' },
              { label: 'This Month', value: '$8,943' },
        ...
        >
          ...
          <div className="flex-1">
            ...
            <p className="font-body text-xs text-text-muted leading-relaxed">
              Your Tuesday revenue is up 28% vs last week. Consider scheduling a payout today before the 4 PM cutoff to hit your bank by tomorrow.
            </p>
            <button
