...
const PERIOD_DATA: Record<Period, PeriodData> = {
  '24h': {
    total: '$1,840', totalRaw: 1840,
    change: '+12.4%', positive: true,
    labels: ['6a', '8a', '10a', '12p', '2p', '4p', '6p', '8p'],
    values: [120, 280, 560, 890, 420, 310, 450, 340],
    peakLabel: '12:00 PM', peakValue: '$890',
    avgLabel: '$230/hr', avgValue: '$230 avg/hr',
    bestLabel: 'Best hour: 12 PM',
  },
  'Week': {
    total: '$11,270', totalRaw: 11270,
    change: '+18.3%', positive: true,
    labels: ['Mon', 'Tue', 'Wed', 'Thu', 'Fri', 'Sat', 'Sun'],
    values: [1180, 1620, 890, 2050, 1340, 1780, 2410],
    peakLabel: 'Sunday Sep 7', peakValue: '$2,410',
    avgLabel: '$1,610/day', avgValue: '$1,610 avg/day',
    bestLabel: 'Best day: Sunday',
  },
  'Month': {
    total: '$39,400', totalRaw: 39400,
    change: '+24.1%', positive: true,
    labels: ['W1', 'W2', 'W3', 'W4'],
    values: [7200, 8450, 9100, 14650],
    peakLabel: 'Week 4', peakValue: '$14,650',
    avgLabel: '$9,850/wk', avgValue: '$9,850 avg/wk',
    bestLabel: 'Best week: W4',
  },
  '3M': {
    total: '$98,200', totalRaw: 98200,
    change: '+31.0%', positive: true,
    labels: ['Jul', 'Aug', 'Sep'],
    values: [28400, 30600, 39200],
    peakLabel: 'September', peakValue: '$39,200',
    avgLabel: '$32,733/mo', avgValue: '$32,733 avg/mo',
    bestLabel: 'Best month: Sep',
  },
  'Year': {
    total: '$318,500', totalRaw: 318500,
    change: '+42.7%', positive: true,
    labels: ['Q1', 'Q2', 'Q3', 'Q4'],
    values: [64200, 79800, 98200, 76300],
    peakLabel: 'Q3 2026', peakValue: '$98,200',
    avgLabel: '$79,625/qtr', avgValue: '$79,625 avg/qtr',
    bestLabel: 'Best quarter: Q3',
  },
}
    ...
    <div className="flex flex-col bg-bg" style={{ minHeight: 785 }}>
      ...
      <div className="flex-1 overflow-y-auto px-5 pb-8 flex flex-col gap-5" style={{ scrollbarWidth: 'none' }}>
        ...
        <div className="grid grid-cols-2 gap-3">
          {[
            { label: 'Total transactions', value: period === '24h' ? '18' : period === 'Week' ? '94' : period === 'Month' ? '312' : period === '3M' ? '870' : '2,940' },
            { label: 'Avg transaction', value: period === '24h' ? '$102' : period === 'Week' ? '$120' : period === 'Month' ? '$126' : period === '3M' ? '$113' : '$108' },
            { label: 'vs prior period', value: d.change, accent: d.positive ? '#22C55E' : '#F87171' },
            { label: 'Projected', value: period === '24h' ? '$1,920' : period === 'Week' ? '$11,800' : period === 'Month' ? '$42,000' : '-' },
          ].map((stat, i) => (
            <div
              key={i}
