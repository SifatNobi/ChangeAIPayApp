...
const REPORT_DATA: Record<ReportPeriod, ReportData> = {
  'Monthly': {
    ...
    values: [28400, 31200, 32800, 31750, 39400],
    peakLabel: 'August', peakValue: '$39,400',
    generated: 'Generated Sep 1, 2026',
    aiSummary: "August was your strongest month on record, driven by a 28% increase in repeat customer spend and three high-value invoices in the final week. The W4 spike to $14,650 was exceptional. Key risk: Wednesday revenue remains consistently 45% below your weekly average, suggesting an addressable dead zone.",
    metrics: [
      { label: 'Total revenue', value: '$39,400', change: '+24.1%', up: true },
      { label: 'Transactions', value: '312', change: '+18', up: true },
      { label: 'Avg transaction', value: '$126', change: '+$8', up: true },
      { label: 'New customers', value: '18', change: '+6', up: true },
    ],
  },
  'Quarterly': {
    hero: '$103,350',
    ...
    labels: ['Q1', 'Q2', 'Q3'],
    values: [72400, 92800, 103350],
    peakLabel: 'Q3 2026', peakValue: '$103,350',
    generated: 'Generated Sep 1, 2026',
    aiSummary: "Q3 2026 closed at $103,350 — your first six-figure quarter. Growth accelerated across all metrics. Repeat customer revenue grew 34% quarter-over-quarter; new customer acquisition remains strong. On current trajectory, Q4 is projected between $108K and $124K depending on holiday period performance.",
    metrics: [
      { label: 'Q3 revenue', value: '$103,350', change: '+28.4%', up: true },
      { label: 'Total transactions', value: '874', change: '+212', up: true },
      { label: 'Avg transaction', value: '$118', change: '+$14', up: true },
      { label: 'New customers', value: '54', change: '+21', up: true },
    ],
  },
}
