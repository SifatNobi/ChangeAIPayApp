...
const LOST_FEATURES: Record<string, LostFeature[]> = {
  ...
  'apex→edge':   [{ label: 'Transfer limit drops to $1,500/mo',   sub: 'Large transfers will be blocked until next cycle',         recoverable: true }, { label: 'FX allowance reduced', sub: 'Edge FX: 0% on first $1,500/mo, then 0.95% (was $6,000/mo allowance)', recoverable: true }, { label: 'Voice Mode no longer available',     sub: 'AI chat stays available; voice is removed',          recoverable: true }],
  ...
  'prime→edge':  [{ label: 'Transfer limit drops to $1,500/mo',   sub: 'Transfers above $1,500/mo will require a conversion fee', recoverable: true }, { label: 'FX allowance reduced to $1,500/mo', sub: '0% FX up to $1,500/mo, then 0.95% (was $3,000/mo allowance on Prime)', recoverable: true }, { label: 'Goals capped at 10',                sub: 'Existing unlimited goals remain; cap applies to new', recoverable: true }],
