...
const MONTHLY_DATA: Record<Month, {
  ...
  aug: {
    label: 'August 2026',
    communityGoalsCompleted: 14280,
    communityStreakDays: 8,
    usersParticipated: 52400,
    challengesRun: 6,
    highlights: [
    ...
    personalPercentile: 74,
    personalRank: 13520,
    personalTotal: 52400,
    personalBestStreak: 19,
    personalGoals: 2,
  },
  sep: {
    label: 'September 2026',
    communityGoalsCompleted: 9140,
    communityStreakDays: 5,
    usersParticipated: 48700,
    challengesRun: 4,
    highlights: [
