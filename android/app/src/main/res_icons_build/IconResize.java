...
public class IconResize {
    public static void main(String[] args) throws Exception {
        ...
        for (Map.Entry<String, Integer> e : sizes.entrySet()) {
            ...
            sb.append(dirName).append(" size=").append(sz).append(" wrote len=")
              .append(new File(dir, "ic_launcher.png").length()).append(" round_len=")
              .append(new File(dir, "ic_launcher_round.png").length()).append("\n");
        }
        sb.append("DONE\n");
        System.out.print(sb.toString());
    }
