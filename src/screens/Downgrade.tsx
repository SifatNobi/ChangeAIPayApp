...
const LOST_FEATURES: Record<string, LostFeature[]> = {
  ...
  'apex→edge':   [{ label: 'Transfer limit drops to $1,500/mo',   sub: 'Large transfers will be blocked until next cycle',         recoverable: true }, { label: 'Zero FX fees removed', sub: '+0.5–1.75% fee applied to foreign currency sends', recoverable: true }, { label: 'Voice Mode no longer available',     sub: 'AI chat stays available; voice is removed',          recoverable: true }],
  ...
  'prime→free':  [{ label: 'Transfer limit drops to $400/mo',     sub: 'Above-limit transfers still go through at ~1.5% fee',    recoverable: true }, { label: 'FX fees reinstated (+1.75%)',       sub: 'Foreign currency transfers will cost more',          recoverable: true }, { label: 'AI Memory reduced to 7 days',       sub: 'Memories older than 7 days will be purged',          recoverable: false }],
