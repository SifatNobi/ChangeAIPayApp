...
const BADGES: Badge[] = [
  // Wellness badges
  { id: 'w1', emoji: '🎯', name: 'First Goal',       description: 'Completed your very first savings goal',        system: 'wellness', status: 'earned',     earnedDate: 'Jul 12',  color: '#22C55E' },
  { id: 'w2', emoji: '🔥', name: '30-Day Streak',    description: '30 consecutive days of consistent saving',      system: 'wellness', status: 'earned',     earnedDate: 'Aug 3',   color: '#FC7E2F' },
  { id: 'w3', emoji: '🛡️', name: 'Budget Guardian',  description: 'Stayed within budget for a full calendar month', system: 'wellness', status: 'earned',     earnedDate: 'Aug 31',  color: '#0066FF' },
  { id: 'w4', emoji: '🌱', name: 'Consistent Saver', description: 'Auto-save active for 3 consecutive months',     system: 'wellness', status: 'inProgress', progress: 2, progressMax: 3, color: '#3FE7FF' },
  { id: 'w5', emoji: '💰', name: 'Goal Tripler',     description: 'Reach 3 savings goals simultaneously',          system: 'wellness', status: 'inProgress', progress: 1, progressMax: 3, color: '#F5B700' },
  { id: 'w6', emoji: '📊', name: 'Insight Reader',   description: 'Reviewed Fina spending report 5 times',        system: 'wellness', status: 'locked',     color: '#9945FF' },
  ...
  { id: 'w8', emoji: '🏦', name: 'Debt-Free Step',   description: 'Paid off a recurring debt tracked in app',      system: 'wellness', status: 'locked',     color: '#AFC5FF' },

  // Circle / status badges
  { id: 'c1', emoji: '✨', name: 'First Spark',     description: 'First active connection in your Change Circle',  system: 'circle',   status: 'earned',     earnedDate: 'Aug 4',   color: '#F5B700' },
  { id: 'c2', emoji: '🔗', name: 'Connector',       description: '3 active connections in your Change Circle',    system: 'circle',   status: 'earned',     earnedDate: 'Aug 20',  color: '#3FE7FF' },
  { id: 'c3', emoji: '📡', name: 'Amplifier',       description: '5 active connections in your Change Circle',    system: 'circle',   status: 'inProgress', progress: 3, progressMax: 5, color: '#0066FF' },
