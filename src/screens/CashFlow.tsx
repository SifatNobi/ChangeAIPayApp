...
const CASH_DATA: Record<Period, CashData> = {
  'Week': {
    net: '$8,220', totalIn: '$14,600', totalOut: '$6,380', netPositive: true,
    change: '+22.4%',
    labels: ['Mon', 'Tue', 'Wed', 'Thu', 'Fri', 'Sat', 'Sun'],
    inValues:  [1800, 2100, 1200, 2600, 1900, 2200, 2800],
    outValues: [800,  950,  600,  1100, 750,  980,  1200],
    peakInLabel: 'Sunday', peakInValue: '$2,800',
    secondary: 'Net cash flow · This week',
  },
  'Month': {
    net: '$26,800', totalIn: '$39,400', totalOut: '$12,600', netPositive: true,
    change: '+19.8%',
    labels: ['W1', 'W2', 'W3', 'W4'],
    inValues:  [7200, 8450, 9100, 14650],
    outValues: [2800, 3100, 2900,  3800],
    peakInLabel: 'Week 4', peakInValue: '$14,650',
    secondary: 'Net cash flow · August 2026',
  },
  '3M': {
    net: '$72,600', totalIn: '$98,200', totalOut: '$25,600', netPositive: true,
    change: '+28.3%',
    labels: ['Jul', 'Aug', 'Sep'],
    inValues:  [28400, 30600, 39200],
    outValues: [9200, 7400,  9000],
    peakInLabel: 'September', peakInValue: '$39,200',
